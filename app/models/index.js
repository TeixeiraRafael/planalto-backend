...
import TripLegReservation from './TripLegReservation';
...
Trip.hasMany(TripLeg, { foreignKey: 'trip_id' });
TripLeg.belongsTo(Trip, { foreignKey: 'trip_id' });

TripLeg.belongsToMany(Reservation, { through: TripLegReservation, foreignKey: 'trip_leg_id' });
Reservation.belongsToMany(TripLeg, { through: TripLegReservation, foreignKey: 'reservation_id' })
